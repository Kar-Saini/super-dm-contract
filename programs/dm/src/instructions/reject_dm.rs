...
use crate::state::{dm_escrow::DMEscrow, dm_pda::DMPda, influencer_profile::InfluencerProfile};

#[derive(Accounts)]
#[instruction(nonce:u64)]
pub struct RejectDM<'info> {
    #[account(mut)]
